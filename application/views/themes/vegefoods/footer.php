...
<section class="ftco-section ftco-no-pt ftco-no-pb py-5 bg-dark">
  ...
  <footer class="ftco-footer ftco-section">
    <div class="container">
        <div class="row">
            <div class="mouse">
                      <a href="#" class="mouse-icon"style="background-color: black; border-radius: 50%; display: flex; justify-content: center; align-items: center; width: 50px; height: 50px;">
                          <div class="mouse-wheel"><span class="ion-ios-arrow-up" style="color:white"></span></div>
                      </a>
                  </div>
        </div>
      <div class="row mb-5">
